...
st.set_page_config(page_title="Movie Trailer Virality", layout="wide")
...
N = st.sidebar.number_input("Total Population", 1000, 1000000, 100000)
initial_I = st.sidebar.number_input("Initial Active Viewers", 1, 10000, 100)
